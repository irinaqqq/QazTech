...
#
# Remove next line if you want to disable automatic Jelastic optimizations 
...
# ServerLimit: sets the maximum configured value for MaxRequestWorkers for the lifetime of the Apache process
